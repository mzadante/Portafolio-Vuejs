...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 1, nombre: 'JavaScript', nivel: 'Avanzado', icono: './src/assets/js.svg' },
            { id: 2, nombre: 'Python', nivel: 'Intermedio', icono: './src/assets/python.svg' },
            { id: 3, nombre: 'HTML/CSS', nivel: 'Avanzado', icono: './src/assets/html-css.svg' },
    ...
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            ...
            { id: 5, nombre: 'Visual Studio Code', nivel: 'Avanzado', icono: './src/assets/visual.svg' }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 1, nombre: 'MongoDB', nivel: 'Avanzado', icono: './src/assets/mongo.svg' },
            { id: 2, nombre: 'MySQL', nivel: 'Intermedio', icono: './src/assets/mysql.svg' },
            { id: 3, nombre: 'PostgreSQL', nivel: 'Intermedio', icono: './src/assets/postgres.svg' }
        ]
    },
    {
        id: 5, nombre: 'Idiomas', habilidades: [
            { id: 1, nombre: 'Español', nivel: 'Nativo', icono: './src/assets/arg.svg' },
            { id: 2, nombre: 'Inglés', nivel: 'Avanzado (C1)', icono: './src/assets/eeuu.svg' }
        ]
    }
]);
